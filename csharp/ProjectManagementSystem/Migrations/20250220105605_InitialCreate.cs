    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignTaskId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TaskItemId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignTasks_AspNetUsers_AssigneeId",
                        column: x => x.AssigneeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignTasks_AspNetUsers_AssignerId",
                        column: x => x.AssignerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignTasks_Tasks_TaskItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignTasks_AssigneeId",
                table: "AssignTasks",
                column: "AssigneeId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignTasks_AssignerId",
                table: "AssignTasks",
                column: "AssignerId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignTasks_TaskItemId",
                table: "AssignTasks",
                column: "TaskItemId");
